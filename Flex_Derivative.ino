...
void testingTimeFunctions(){
  ...
  continuous_delta_time = time_millis - continuous_delta_time;

  continuous_sample_rate = trueFlex * continuous_delta_time;

  Serial.print(" continuous delta time: ");
  Serial.print(continuous_delta_time);
  Serial.print(" continuous rate change: ");
  ...
  if(time_millis % 2000 ){
    ...
    one_second_rate = trueFlex * one_second_delta_time;
    two_second_rate = trueFlex * two_second_delta_time;
